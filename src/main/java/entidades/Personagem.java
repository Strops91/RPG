...
public class Personagem {
	...
	public Personagem(String nome, int bonusVida, int bonusEscudo, int bonusFisico, int bonusHabilidade) {
		super();
		this.nome = nome;
	...
	public String toString() {
		return "Personagem [id=" + id + ", nome=" + nome + ", bonusVida=" + bonusVida + ", bonusEscudo=" + bonusEscudo
